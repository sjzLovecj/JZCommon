...
public struct SJZFirstLunch {
    ...
    @AppStorage("isFirstLunch") public var isFirstLunch: Bool = true
    @AppStorage("appVersion") public var appVersion: String = ""
    ...
    public func updateVersion(complete: (_ isFirstLunch: Bool) -> ()) {
